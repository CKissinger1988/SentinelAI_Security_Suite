  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 relative select-none">
      <svg
        height="210"
        width="210"
        className="transform -rotate-90 drop-shadow-[0_0_10px_var(--theme-glow-color)]"
      >
      ...
      <div className="absolute top-[48px] flex flex-col items-center justify-center font-mono">
        <span className="text-[14px] font-black text-white tracking-tighter animate-pulse">
          {threat}%
        </span>
        <span className="text-[6px] text-red-400 uppercase tracking-widest font-bold">
          Threat Index
        </span>
      </div>
      <div className="absolute top-[82px] left-[54px] flex flex-col items-center justify-center font-mono">
        ...
        <span className="text-[5px] text-emerald-400 uppercase tracking-widest font-bold">
          Shield Integrity
        </span>
      </div>
      <div className="absolute top-[82px] right-[54px] flex flex-col items-center justify-center font-mono">
        ...
        <span className="text-[5px] text-cyan-400 uppercase tracking-widest font-bold">
          Network Entropy
        </span>
      </div>

      <span className="text-[7px] font-mono text-slate-500 uppercase tracking-widest mt-4 font-bold">
        Orbital Telemetry HUD Active
      </span>
    </div>
  );
};
      ...
      <div className="lg:col-span-1 space-y-6 flex flex-col">
        ...
        <div className="glass-hologram p-5 rounded-2xl flex flex-col justify-between">
          <div className="flex items-center justify-between mb-3">
            <span className="text-[9px] font-black text-white uppercase font-mono tracking-tighter">
              Mobile_C2_Sovereign_Link
            </span>
            <span className="text-[7px] text-purple-400">
              {c2Status?.encryptionLevel || "AES-XTS"}
            </span>
          </div>
          <div className="grid grid-cols-2 gap-2 text-center">
            <div className="bg-black/30 p-2 border border-slate-900 rounded-lg">
              <div className="text-[6px] text-slate-500 uppercase font-mono">
                CONN
              </div>
          ...
          <div className="relative flex flex-col h-full justify-between">
            <div className="flex justify-between items-start">
              <div className="space-y-1">
                <span className="text-[9px] font-black text-white tracking-tighter italic">
                  LAUNCH_CLOUD_DESK
                </span>
                <p className="text-[6px] text-slate-500 font-mono tracking-widest uppercase">
                  SESSION: RDP-01
                </p>
              </div>
              <ExternalLink className="w-3.5 h-3.5 text-cyan-500 group-hover:scale-110 transition-transform" />
            </div>
            <span className="text-[8px] font-mono text-emerald-500 font-bold uppercase tracking-widest">
              Tunnel Secured
            </span>
          </div>
        </div>
