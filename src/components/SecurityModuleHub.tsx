...
const MODULE_REGISTRY: HubModule[] = [
  // ── Defensive Mesh ──
  { id: 'spartan-core', name: 'SpartanAI Redundancy Core', file: 'spartanai.py', category: 'Defensive Mesh', categoryKey: 'defensive', description: 'Monitors AI operational health, heartbeat validation, and instant failover with evasion protocols.', tags: ['monitor', 'failover', 'evasion'], size: 4181, risk: 'low', status: 'available', sourcePath: 'backend/core/spartan.py', version: '3.1.0' },
  ...
  { id: 'self-healing-spartan', name: 'Self-Healing SpartanAI', file: 'self_healing_spartanai.py', category: 'Defensive Mesh', categoryKey: 'defensive', description: 'Dual-mode spartan that heals itself during active intrusion attempts.', tags: ['spartan', 'IDS', 'self-heal'], size: 6320, risk: 'low', status: 'available', sourcePath: 'backend/core/services/self_healing_spartan.py', version: '1.9.0' },
