...
export const Settings: React.FC<SettingsProps> = ({ open, onClose }) => {
  ...
  return (
    <AnimatePresence>
      {" "}
      {/* AnimatePresence should wrap the conditional component */}
      {open /* Conditionally render the motion.div */ && (
        ...
        >
          <motion.div
            ...
            className="bg-[#0b0e14] border border-cyan-900/50 w-full max-w-lg rounded-2xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh]"
          >
            <div className="p-4 border-b border-cyan-900/30 flex items-center justify-between">
              <h2 className="text-sm font-mono text-cyan-400 tracking-wider font-bold">
